...
export class CreateUsersTable1744047906348 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`user\` ADD \`verificationExpires\` datetime NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX \`IDX_f4af5b76b36036a609b31e22ea\` ON \`user\` (\`verificationOtp\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_1913ba03c6cc6453978fa7972f\` ON \`user\` (\`verificationExpires\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_a86420b06e5fc63b39fc44987f\` ON \`user\` (\`resetPasswordOtp\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_5e7efe552d0e777ef1c0889b9e\` ON \`user\` (\`resetPasswordExpires\`)`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX \`IDX_5e7efe552d0e777ef1c0889b9e\` ON \`user\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_a86420b06e5fc63b39fc44987f\` ON \`user\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_1913ba03c6cc6453978fa7972f\` ON \`user\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_f4af5b76b36036a609b31e22ea\` ON \`user\``,
    );
    await queryRunner.query(
